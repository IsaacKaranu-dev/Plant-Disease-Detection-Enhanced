# ⭐Plant-Disease-Detection (Enhanced)  
*Based on the open-source work by [Manthan Bhikadiya](https://github.com/manthan89-py)), with significant improvements by [Isaac Karanu] (https://github.com/IsaacKaranu-dev)  
